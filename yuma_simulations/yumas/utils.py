...
class YumaSimulationNames:
    ...
    YUMA3B: str = "Yuma 3 (Rhef) + bond scaling"
    YUMA3B1: str = "Yuma 3.1 (Rhef+reset) + bond scaling"
    YUMA3B2: str = "Yuma 3.2 (Rhef+conditional) + bond scaling"
    YUMA4: str = "Yuma 4 (Rhef+relative bonds)"
    YUMA4B: str = "Yuma 4 b (Rhef+relative bonds) + bond scaling"
    YUMA4_LIQUID: str = "Yuma 4 (Rhef+relative bonds) - liquid alpha on"
    YUMA4B_LIQUID: str = "Yuma 4 (Rhef+relative bonds) + bond scaling - liquid alpha on"
